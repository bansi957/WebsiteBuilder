...
function LoginModel({ open, onClose }) {
    ...
    const handleGoogleAuth=async ()=>{
        try {
            ...
            const res=await axios.post(`${serverUrl}/api/auth/googleauth`,{name:result.user.displayName,email:result.user.email,avatar:result.user.photoURL},{withCredentials:true})
              ...
              <div className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
                    ...
                    <div className="relative px-8 pt-14 pb-10 text-center">
                        ...
                        <h2 className="text-3xl font-semibold leading-tight mb-3 space-x-2">
                            ...
                            whileTap={{scale:0.96}}
                            className="group realative w-full h-13 rounded-xl bg-white text-black font-semibold  shadow-xl overflow-hidden"
                            onClick={handleGoogleAuth}>
                                <div className="relative flex items-center  justify-center gap-3"><img src="https://www.svgrepo.com/show/303108/google-icon-logo.svg" alt="" className="w-5 h-5"/>
                            ...
                            <p className="text-xs text-zinc-500 leading-relaxed">
                                ...
                                <span className="underline cursor-pointer hover:text-zinc-300 ">Terms and Service</span>{" "}
                                and{" "}
                                <span className="underline cursor-pointer hover:text-zinc-300"> Privay Policy</span>
