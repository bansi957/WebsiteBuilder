        ...
        <section className='pt-44 pb-32 px-6 text-center'>
            ...
            className='mt-8 max-w-2xl mx-auto text-zinc-400 text-lg'
             >
                ...
                <button className=' mt-12 px-10 py-4 rounded-xl bg-white text-black font-semibold hover:scale-105 transition' onClick={()=>setOpenLogin(true)}>Get Started</button>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-10'>
                {highlights.map((h,i)=>(
                    ...
                    >
                        ...
                        <p className='text-sm text-zinc-400'>GenWeb.ai builds real websites - clean code,
